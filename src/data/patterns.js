 ...
 *
 * Single source of truth for the detector (1AM-56) and the photo endpoint (1AM-57).
 ...
 *
 * Conventions:
 * - All regex patterns are case-insensitive (the detector applies the `i` flag).
 * - Latin names are matched as whole words (\b boundaries) to avoid false hits
 *   on substrings.
 * - Decoder texts are factual, max 50 words, no medical claims, no halal claims.
 *
 * Last reviewed: 2026-05-04 (1AM-54)
 */
...
/**
 * Helper exports voor de detector (1AM-56) en photo endpoint (1AM-57).
 * Houdt de detector-logic los van de pattern-data, zodat tests en endpoints
